...
def run_backtest(csv_path, verbose=False, date_start=None, date_end=None):
    print("=" * 70)
    print("  JIMI FRAMEWORK v6.16 BEAST — Backtest Engine (M1-M12 + Adaptive Direction)")
    ...
    for idx in range(len(df_15m)):
        ...
        if len(trades) >= rolling_window:
            ...
            if rolling_wr < rolling_min:
                # Only pause if we also have net negative PnL in window
...
def print_report(trades, stats):
    ...
    print("\n" + "═" * 70)
    print("  JIMI v6.16 BEAST — BACKTEST RESULTS (12 Modules + Adaptive Direction)")
    print("═" * 70)

...
def calc_ics(m1_score, m2_score, m3_score, m4_score, m4_status, m5_score=0.5, m6_score=0.5, use_derivatives=False):
    m4_contrib = m4_score if m4_status == 'PASS' else 0.5
    if use_derivatives and HAS_DERIVATIVES:
        # Use adjusted weights with derivatives
...
def scan_signal(df_15m, df_1h, df_2h, df_4h, df_1d):
    ...
    ics, effective_floor = calc_ics(m1_score, m2_score, m3_score, m4_score, m4_status, m5_score,
                                     m6_score, use_derivatives=use_deriv)
